...
>
    ...
    >
        ...
        >
            ...
            >
                <h1 class="mb-1 font-medium">Hadi başlayalım</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                    Laravel'in inanılmaz zengin bir ekosistemi var. <br
                    />Aşağıdakilerle başlamanı öneririz.
                </p>
                <ul class="mb-4 flex flex-col lg:mb-6">
                    ...
                    >
                        ...
                        <span>
                            Video eğitimlerini şurada izle:
                            <a
